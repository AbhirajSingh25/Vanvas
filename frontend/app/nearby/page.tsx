...
const CATEGORIES = [
  ...
  { id: "street_food", label: "Street Food", hindi: "स्ट्रीट फ़ूड", icon: Utensils },
  { id: "local_food", label: "Local Food", hindi: "स्थानीय भोजन", icon: Utensils },
  { id: "attraction", label: "Attractions", hindi: "आकर्षण", icon: Compass },
  { id: "viewpoint", label: "Viewpoints", hindi: "व्यू पॉइंट", icon: Trees },
  { id: "temple", label: "Temples", hindi: "मंदिर व तीर्थ", icon: Landmark },
  { id: "heritage", label: "Heritage", hindi: "धरोहर", icon: Landmark },
  { id: "shop", label: "Shops", hindi: "दुकानें", icon: ShoppingBag },
  { id: "market", label: "Markets", hindi: "बाज़ार", icon: ShoppingBag },
  { id: "souvenir", label: "Souvenirs", hindi: "स्मृति चिन्ह", icon: ShoppingBag },
  { id: "craft", label: "Handicrafts", hindi: "हस्तशिल्प", icon: ShoppingBag },
  { id: "bike_rental", label: "Bike Rentals", hindi: "बाइक किराया", icon: Bike },
  { id: "scooter_rental", label: "Scooter Rentals", hindi: "स्कूटर किराया", icon: Bike },
  { id: "car_rental", label: "Car Rentals", hindi: "कार किराया", icon: Bike },
  { id: "hotel", label: "Hotels", hindi: "होटल", icon: BedDouble },
  { id: "hostel", label: "Hostels", hindi: "होस्टल", icon: BedDouble },
  { id: "homestay", label: "Homestays", hindi: "होमस्टे", icon: BedDouble },
  { id: "fuel", label: "Fuel Pumps", hindi: "पेट्रोल पंप", icon: ShieldAlert },
  { id: "pharmacy", label: "Pharmacies", hindi: "दवाइयाँ", icon: ShieldAlert },
  { id: "hospital", label: "Hospitals", hindi: "अस्पताल", icon: ShieldAlert },
  { id: "atm", label: "ATMs", hindi: "एटीएम", icon: ShieldAlert },
];
