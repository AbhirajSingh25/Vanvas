...
export const FloatingCopilotTrigger: React.FC<FloatingCopilotTriggerProps> = ({
  ...
  return (
    <button
      ...
      className="md:hidden fixed bottom-[calc(4.75rem+env(safe-area-inset-bottom,0px))] right-4 z-40 group cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#B49252] focus:ring-offset-2 focus:ring-offset-[#EFE5D2] transition-all duration-300 transform active:scale-90"
    >
